...
export default function ReadingPracticeHome() {
  return (
    <LandingStyleLayout title="IELTS Reading Practice">
      <div className="max-w-2xl mx-auto p-6 flex flex-col gap-8 text-white">
        {/* Heading */}
        <div>
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          {/* Practice Mode */}
          <div className="flex-1 bg-green-100 bg-opacity-10 border border-green-300 rounded-2xl p-5 flex flex-col items-center shadow">
            <h2 className="text-xl font-semibold mb-1 text-green-200">📘 Practice Mode</h2>
          ...
          {/* Live Test Mode */}
          <div className="flex-1 bg-blue-100 bg-opacity-10 border border-blue-300 rounded-2xl p-5 flex flex-col items-center shadow">
            <h2 className="text-xl font-semibold mb-1 text-blue-200">🧪 Live Test Mode</h2>
            <p className="text-gray-300 mb-3 text-center text-sm">
        ...
        {/* Tips & Instructions */}
        <div className="bg-yellow-100 bg-opacity-10 border border-yellow-300 rounded-2xl p-6 shadow flex flex-col gap-2">
          <h3 className="text-lg font-bold mb-2 text-yellow-300">📖 Instructions & Tips</h3>
          <ul className="list-disc ml-6 text-gray-300 space-y-1 text-sm">
            ...
            <li>Use the <span className="font-mono bg-gray-700 text-white px-1 rounded">Flag</span> feature to review tricky questions before submitting.</li>
