...
function ProgressRing({ id, percent, color, label, band, darkMode }: {
  id: string,
  percent: number,
  color: string,
  label: string,
...
function StudyPlanItem({ lesson, continueLesson, darkMode }: {
  lesson: Lesson,
...
// Writing Sample Item
function WritingSampleItem({ sample, viewWritingFeedback, darkMode }: {
  sample: any,
